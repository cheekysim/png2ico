...
[tsizes.append(str(file.split(".")[0])) for file in os.listdir(os.getcwd()) if file.lower().split(".")[0] in psizes]
[msizes.append(size) for size in psizes if size not in tsizes]
convert = "n"
if msizes:
